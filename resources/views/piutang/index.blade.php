...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           <i class="fa fa-user"></i> Piutang Nasabah
    ...
    <div class="row" >
        <div class="col-md-12" >
            <div class="card">
              <a href="{{route('piutang.create')}}">Add</a>
                <br>
                <span class="alert alert-info">NB: Piutang hari ini akan di tambahkan otamatis oleh sistem setiap jam 22.00 WIB  </span>
                <br>
                <div class="card-body">
                    @if (session('pesan'))
                        ...
                        <tbody>
                          @foreach ($piutang as $item)
                            <tr>
                                ...
                                <td>Rp.{{number_format($item->Piutang)}}</td>
                            </tr>
                          @endforeach
                        </tbody>
                      </table>
                ...
                <div class="table-responsive">
                  <table class="table" id="myTable">
                      ...
                      <tbody>
                          <tr>
                              <td scope="row">#</td>
                              <td>Rp.{{number_format($piutang_total)}}</td>
                          </tr>
                      </tbody>
                    </table>
              </div>
