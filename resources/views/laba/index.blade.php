...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
           <i class="fa fa-user"></i> Laba Nasabah
    ...
    <div class="row" >
        <div class="col-md-12" >
            <div class="card">
                <br>
                <span class="alert alert-info">NB: Laba Transaksi hari ini akan di tambahkan otamatis oleh sistem setiap jam 22.00 WIB  </span>
                <br>
                <div class="card-body">
                    @if (session('pesan'))
                ...
                <div class="table-responsive">
                  <table class="table" id="myTable">
                      ...
                      <tbody>
                          <tr>
                              <td scope="row">#</td>
                              <td>Rp.{{number_format($laba->sum('Keuntungan'))}}</td>
                          </tr>
                      </tbody>
                    </table>
              </div>
