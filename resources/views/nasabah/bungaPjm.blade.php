    ...
    <div class="row" >
        <div class="col-md-12" >
            <div class="card">
                ...
                <br>
                <span class="alert alert-info">NB: Total Pinjaman akan di tambahkan bunga sebesar
                    <i class ="btn-danger"> 20% </i></span>
                <br>
                <div class="card-body">
                    @if (session('pesan'))
                        ...
                        <tbody>
                            @foreach ($nasabah as $item)
                                <tr>
                                    ...
                                    <td>Rp.{{number_format($item->jumlah_pinjaman * 20/100)}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                      </table>
