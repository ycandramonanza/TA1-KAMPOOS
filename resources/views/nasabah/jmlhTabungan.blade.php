        ...
        <div class="col-md-12" >
            <div class="card">
                ...
                <span class="alert alert-info">NB: Total Tabungan Nasabah Saat ini adalah
                   <i class ="btn-danger"> Rp.{{number_format($nasabah->sum('jumlah_tabungan'))}}</i></span>
                <br>
                <div class="card-body">
                    @if (session('pesan'))
                        ...
                        <tbody>
                            @foreach ($nasabah as $item)
                                <tr>
                                    ...
                                    <td><a href="{{route('transaksi-tabungan', $item->id)}}" class="btn btn-info" style="color: white"><i class="fas fa-hand-holding-usd"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                      </table>
